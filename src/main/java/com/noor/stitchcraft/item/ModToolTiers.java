...
public class ModToolTiers {
    public static final Tier SHADOW = new ForgeTier(2031, 9, 4.0F, 38, ModTags.Blocks.NEEDS_ALEXANDRITE_TOOL, () -> Ingredient.of(ModItems.SHADOW_INGOT.get()), ModTags.Blocks.INCORRECT_FOR_ALEXANDRITE_TOOL);
